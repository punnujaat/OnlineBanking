...
<table><%
		...
		if(status==true){
			...
			PreparedStatement ps=con.prepareStatement("Select * from newaccount.raft where AccountNo=?");
			...
			PreparedStatement ps1=con1.prepareStatement("update newaccount.raft set Amount=? where AccountNo='"+accountno+"'");
			ps1.setInt(1,dataamount);
			ps1.executeUpdate();
			PreparedStatement ps2=con2.prepareStatement("select Amount from newaccount.raft where AccountNo='"+accountno+"'");
